...
public class UserInfo {
	...
	public Map<String, Object> getFixData() {
		...
		mData.put("COMPANY_ID", this.getCOMPANY_ID());
		mData.put("USER_NO", this.getUSER_NO());
		mData.put("USER_ID", this.getUSER_ID());
		mData.put("USER_NM", this.getUSER_NM());
	...
	public Map<String, Object> toMapping(Map<String, Object> amData) {
		amData.put("COMPANY_ID", this.getCOMPANY_ID());
		amData.put("USER_NO", this.getUSER_NO());
		amData.put("USER_ID", this.getUSER_ID());
		amData.put("USER_NM", this.getUSER_NM());
